...
class DiffWithWorkingCommand extends commands_1.ActiveEditorCommand {
    constructor(git) {
        super(commands_1.Commands.DiffWithWorking);
        this.git = git;
    }
    execute(editor, uri, commit, line) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!commit || gitProvider_1.GitProvider.isUncommitted(commit.sha)) {
                ...
                try {
                    const log = yield this.git.getLogForFile(gitUri.fsPath, gitUri.sha, gitUri.repoPath, undefined, gitUri.sha ? undefined : 1);
                    if (!log)
