...
class OpenRemotesCommandQuickPickItem extends common_1.CommandQuickPickItem {
    constructor(remotes, type, branchOrShaOrFileName, goBackCommandOrFileBranch, fileShaOrCommit, goBackCommand) {
        let fileBranch;
        ...
        switch (type) {
            ...
            case 'working-file':
                ...
                if (fileShaOrCommit instanceof gitService_1.GitLogCommit) {
